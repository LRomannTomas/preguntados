...
sonido_fondo = pygame.mixer.Sound("archivos/musica.mp3")
sonido_fondo.set_volume(0.2)
sonido_fondo.play()

sonido_error = pygame.mixer.Sound("archivos/sonido_error.wav")
sonido_acierto = pygame.mixer.Sound("archivos/sonido_acierto.mp3")
sonido_pregunta = pygame.mixer.Sound("archivos/sonido_pregunta.mp3")
...
imagen = pygame.image.load("archivos/logo_preguntados.png")
imagen = pygame.transform.scale(imagen,(150,150))

background = pygame.image.load("archivos/back_wood.jpeg").convert()
background = pygame.transform.scale(background,(810,ALTO_VENTANA))

remarco = pygame.image.load("archivos/wood_white.jpg")
remarco = pygame.transform.scale(remarco,(208,107))

fondo_boton = pygame.image.load("archivos/wood_black.jpg")
fondo_boton = pygame.transform.scale(fondo_boton,(200,100))

corazon_vida_1 = pygame.image.load("archivos/corazon.png")
corazon_vida_1 = pygame.transform.scale(corazon_vida_1,(60,60))

corazon_vida_2 = pygame.image.load("archivos/corazon.png")
    ...
    for evento in lista_eventos:
        ...
        if evento.type == pygame.MOUSEBUTTONDOWN:
            ...
            if perimetro_boton_reiniciar:
                ...
                perimetro_boton_reiniciar = False
                
           
            
            if  perimetro_boton_pregunta == True or perimetro_boton_reiniciar:
